...
Click _Check my progress_ to verify the objective. Configure HTTP and health check firewall rules
...
Click _Check my progress_ to verify the objective. Configure instance templates and instance group
...
Click _Check my progress_ to verify the objective. Configure the HTTP Load Balancer
...
Click _Check my progress_ to verify the objective. Denylist the siege-vm
